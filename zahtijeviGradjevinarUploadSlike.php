...
<html>
    ...
    <body>
        <form action="php_xml/uploaderSlike.php" method="post" name="uploadSlike" id="obrazac" enctype="multipart/form-data" >
                <div id="greske"></div>
                
                <h3 align="center">Postavljanje slika</h3>
                <label for="datoteka"><b>Odaberite slike za selektirani projekt: </b></label>
