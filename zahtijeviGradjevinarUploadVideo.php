...
<html>
    ...
    <body>
        <form action="php_xml/uploaderVideo.php" method="post" name="uploadSlike" id="obrazac" enctype="multipart/form-data" >
                <div id="greske"></div>
                
                <h3 align="center">Postavljanje videa</h3>
                <label for="datoteka"><b>Odaberite video za selektirani projekt: </b></label>
