...
// one more check: does the file have the right MIME type?
        ...
        if ($userfile_type != 'application/pdf'&& $userfile_type != 'text/plain') {
            echo 'Problem: datoteka nije pdf ili plain text - ' . $userfile_name;
            exit;
        }

// put the file where we'd like it
        $upfile1 = 'dokumenti/' . $userfile_name;
        $upfile = '../';
        $upfile .= $upfile1;
...
$sql = "INSERT INTO `dokument`(`naslov`, `link`, `zahtijev_idzahtijeva`) "
