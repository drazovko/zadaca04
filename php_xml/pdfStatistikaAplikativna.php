...
if (isset($_GET['zupanija'])) {
        $idZupanije = intval($_GET['zupanija']);
} else{
    $idZupanije = '6';    
}
//
...
PDF_set_info($p, "Creator", "pdfStatiskikaAplikativna.php");
...
$textPdf = "Broj zahtijeva po zupaniji i/ili moderatoru ";
...
if ($brojRedova) {
    ...
    //računanje prosječne ocjene za moderatora odabrane županije 2. dio
        ...
        $output = '<zahtijevaPoGradjevinaru="' . $brojacZahtijeva 
                . '" ukupnoZahtijeva="' . $ukupnoZahtijeva 
                . '" videaPoGradjevinaru="' . $ukupnoVideaPoGradjevinaru 
                . '" videaPoZupaniji="' . $ukupnoVideaPoZupaniji 
                . '" ocjenaPoGradjevinaru="' . $prosjecnaOcjenaPoGradjevinaru 
                . '">' . $brojacZahtijeva . '</name>' . "\n";
        
       
    
        $razmak = (($broj++) * $velicina) + 10;
        PDF_show($p, $ime . "  -  " . $prezime . "  -  " . $ukupnoZahtijeva . "  -  " . $ukupnoVideaPoGradjevinaru . "  -  " . $prosjecnaOcjenaPoGradjevinaru);
